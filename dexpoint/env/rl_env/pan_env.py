...
from dexpoint.env.sim_env.pan_env import PanSimEnv
from dexpoint.real_world import lab

OBJECT_LIFT_LOWER_LIMIT = -0.03


class PanRLEnv(PanSimEnv, BaseRLEnv):
...
def main_env():
    ...
    env = PanRLEnv(use_gui=True, robot_name="allegro_hand_xarm6_wrist_mounted_face_front",
