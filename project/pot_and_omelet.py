...
if __name__ == '__main__':
    def create_env_fn():
        ...
        env_params = dict(object_name=object_name, rotation_reward_weight=rotation_reward_weight,
                          randomness_scale=1, use_visual_obs=use_visual_obs, use_gui=True, no_rgb=True)
        ...
        # print(AllegroRelocateRLEnv.__mro__)       # Inheritance of the related classes of AllegroRelocateRLEnv
